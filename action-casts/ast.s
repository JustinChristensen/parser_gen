...
# %bb.0:
	...
	movq	%rsi, -16(%rbp)
.Ltmp0:
	.loc	2 104 63 prologue_end   # ast.c:104:63
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Ltmp1:
...
.Ltmp4:
	...
	movq	-8(%rbp), %rdi
	.loc	2 111 29 is_stmt 0      # ast.c:111:29
	movq	-16(%rbp), %rsi
	.loc	2 111 42                # ast.c:111:42
	movq	-8(%rbp), %rax
	movq	%rdi, -48(%rbp)         # 8-byte Spill
	.loc	2 111 36                # ast.c:111:36
	movq	%rax, %rdi
...
.Ltmp6:
	...
	movq	-8(%rbp), %rdi
	.loc	2 115 29 is_stmt 0      # ast.c:115:29
	movq	-16(%rbp), %rsi
	.loc	2 115 42                # ast.c:115:42
	movq	-8(%rbp), %rax
	movq	%rdi, -48(%rbp)         # 8-byte Spill
	.loc	2 115 36                # ast.c:115:36
	movq	%rax, %rdi
	movq	%rsi, -56(%rbp)         # 8-byte Spill
	callq	gexpr
